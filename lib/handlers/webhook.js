...
async function probeCustomFields(state,locationId){
 ...
 let token='';try{token=await getValidLocationToken(state,locationId,saveState)}catch(e){return {error:`token Location: ${e?.message||e}`}}
 const versions=['2023-02-21','2021-07-28'];const probes=[];
