...
export async function POST(request) {
  try {
    ...
    const user = { id: uid(), authUserId: authUser.id, name, email, passwordHash: hashPassword(password), role: "agency_admin", institutId: null, active: true, createdAt: new Date().toISOString() };
