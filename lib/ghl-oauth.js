...
async function fetchInstalledLocations(agency){
  ...
  // HighLevel OAuth v3 /oauth/installed-locations n'accepte plus skip/limit.
  // Une seule requête retourne les emplacements installés autorisés pour l'app.
  const q=new URLSearchParams({companyId:agency.companyId,appId:appId(),isInstalled:"true"});
