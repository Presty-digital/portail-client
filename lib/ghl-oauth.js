...
async function fetchInstalledLocations(agency){
  ...
  for(let page=0;page<20;page++){
    ...
    const r=await fetch(`${API_BASE}/oauth/installed-locations?${q}`,{headers:{Accept:"application/json",Authorization:`Bearer ${agency.accessToken}`,Version:API_VERSION},cache:"no-store"});
